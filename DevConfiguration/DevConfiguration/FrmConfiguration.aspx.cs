...
namespace DevConfiguration
{
    public partial class FrmConfiguration : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lblCOMPANY_NAME.Text = WebConfigurationManager.AppSettings["COMPANY_NAME"].ToString();
            lblASPNETBOOKTEST_ConnectionString.Text =
                WebConfigurationManager.ConnectionStrings["ASPNETBOOKTEST_ConnectionString"].ConnectionString;
        }
    }
}