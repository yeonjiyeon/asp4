...
namespace DevADONET
{
    public partial class FrmMemoSearch : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                if (lstSearchField.Items[i].Text == ds.Tables[0].Rows[0]["UPLOADTYPE"].ToString())
                {
                    lstSearchField.SelectedIndex = -1; //0보다 작은 값으로 먼저 설정을 해줘야 한다.
                    lstSearchField.Items[i].Selected = true;
                }
            }*/
